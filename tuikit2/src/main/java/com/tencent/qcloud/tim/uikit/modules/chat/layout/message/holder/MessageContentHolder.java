...
public abstract class MessageContentHolder extends MessageEmptyHolder {
    ...
    public void layoutViews(final MessageInfo msg, final int position) {
        ...
        if (properties.getAvatarRadius() != 0) {
            leftUserIcon.setRadius(360);
            rightUserIcon.setRadius(360);
        } else {
            leftUserIcon.setRadius(360);
            rightUserIcon.setRadius(360);
        }
        ...
        if (!TextUtils.isEmpty(timMessage.getFaceUrl())) {
            ...
            if (msg.isSelf()) {
              //  rightUserIcon.setIconUrls(urllist);
                Glide.with(itemView.getContext()).applyDefaultRequestOptions(new RequestOptions().circleCrop()).load(urllist.get(0)).into(rightUserIcon.getmIconView());
            } else {
              //  leftUserIcon.setIconUrls(urllist);
                Glide.with(itemView.getContext()).applyDefaultRequestOptions(new RequestOptions().circleCrop()).load(urllist.get(0)).into(leftUserIcon.getmIconView());
            }
        }
