...
public class TCVideoPublisherActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUGCKitVideoPublish.setUserInfo(MyUserInstance.getInstance().getUserinfo().getId(), MyUserInstance.getInstance().getUserinfo().getToken());
        /**
         * 设置发布视频的路径和封面
         */
    ...
    private void backToMainActivity() {
        Intent intent = new Intent(TCVideoPublisherActivity.this, HomeActivity.class);
