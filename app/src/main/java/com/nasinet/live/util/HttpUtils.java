...
public class HttpUtils {
    ...
    //用户实名认证
    public void identityAuth(String real_name, String id_num, String alipay_account, String alipay_name, String id_card_url, StringCallback stringCallback) {
