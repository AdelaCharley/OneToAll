...
public class MyXPopup {
    ...
    private static int shadowBgColor = Color.parseColor("#00000000");
    ...
    public static class Builder {
        ...
        public MyXPopup.Builder popupType(PopupType popupType) {
         ...
         * @return
         */
        public MyXPopup.Builder dismissOnBackPressed(Boolean isDismissOnBackPressed) {
         ...
         * @return
         */
        public MyXPopup.Builder dismissOnTouchOutside(Boolean isDismissOnTouchOutside) {
         ...
         * @return
         */
        public MyXPopup.Builder autoDismiss(Boolean autoDismiss) {
         ...
         * @return
         */
        public MyXPopup.Builder hasShadowBg(Boolean hasShadowBg) {
         ...
         * @return
         */
        public MyXPopup.Builder atView(View atView) {
         ...
         * @return
         */
        public MyXPopup.Builder watchView(View watchView) {
         ...
         * @return
         */
        public MyXPopup.Builder popupAnimation(PopupAnimation popupAnimation) {
         ...
         * @return
         */
        public MyXPopup.Builder customAnimator(PopupAnimator customAnimator) {
         ...
         * @return
         */
        public MyXPopup.Builder maxWidth(int maxWidth) {
         ...
         * @return
         */
        public MyXPopup.Builder maxHeight(int maxHeight) {
         ...
         * @return
         */
        public MyXPopup.Builder autoOpenSoftInput(Boolean autoOpenSoftInput) {
         ...
         * @return
         */
        public MyXPopup.Builder moveUpToKeyboard(Boolean isMoveUpToKeyboard) {
         ...
         * @return
         */
        public MyXPopup.Builder popupPosition(PopupPosition popupPosition) {
         ...
         * @return
         */
        public MyXPopup.Builder hasStatusBarShadow(boolean hasStatusBarShadow) {
         ...
         * @return
         */
        public MyXPopup.Builder offsetX(int offsetX) {
         ...
         * @return
         */
        public MyXPopup.Builder offsetY(int offsetY) {
         ...
         * @return
         */
        public MyXPopup.Builder enableDrag(boolean enableDrag) {
         ...
         * @return
         */
        public MyXPopup.Builder isCenterHorizontal(boolean isCenterHorizontal) {
         ...
         * @return
         */
        public MyXPopup.Builder isRequestFocus(boolean isRequestFocus) {
         ...
         * @return
         */
        public MyXPopup.Builder autoFocusEditText(boolean autoFocusEditText) {
...
//        }
         ...
         * @return
         */
        public MyXPopup.Builder setPopupCallback(XPopupCallback xPopupCallback) {
