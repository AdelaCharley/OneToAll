...
import com.nasinet.live.ui.adapter.LiveTrendsAdapter;
import com.nasinet.live.ui.adapter.TrendsAdapter;
import com.nasinet.live.dialog.UnlockDialog;
import com.nasinet.live.util.MyUserInstance;
import com.nasinet.live.widget.MyRecyclerView;
import com.nasinet.live.widget.ViewPagerForScrollView;
...
public class UserTrendsFragment extends BaseMvpFragment<HomePresenter> implements HomeContract.View, BGANinePhotoLayout.Delegate {
    ...
    protected void initView(View view) {
        ...
        if (getArguments() != null) {
            ...
            if (getArguments().getSerializable("authorInfo") != null) {
                authorInfo = (AnchorInfo) getArguments().getSerializable("authorInfo");
            }
    ...
    private View initAnchor(AnchorInfo anchorInfo) {
        ...
        Glide.with(getContext()).load(MyUserInstance.getInstance().getLevel(anchorInfo.getAnchor_level())).into(iv_anchor_level);
        ...
        if (anchorInfo.getVip_level() != null & anchorInfo.getVip_date() != null) {
            if (!anchorInfo.getVip_level().equals("0")) {
                ...
                if (MyUserInstance.getInstance().OverTime(anchorInfo.getVip_date())) {
                    Glide.with(getContext()).load(MyUserInstance.getInstance().getVipLevel(anchorInfo.getVip_level())).into(iv_vip);
