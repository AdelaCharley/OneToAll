...
public class RankAnchorItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView iv_user_level, tv_attention;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (position == 0) {
            ...
            Glide.with(context).applyDefaultRequestOptions(new RequestOptions().centerCrop()).load(MyUserInstance.getInstance().getAnchorLevel(rankItems.get(0).getAnchor().getAnchor_level())).into(((TopViewHolder) holder).iv_top1_level);

            if(rankItems.get(0).getAnchor().getVip_level()!=null) {
                if (!rankItems.get(0).getAnchor().getVip_level().equals("0")) {
                    ...
                    Glide.with(context).load(MyUserInstance.getInstance().getVipLevel(rankItems.get(0).getAnchor().getVip_level())).into(((TopViewHolder) holder).iv_top1_vip_level);
                } else {
                    ((TopViewHolder) holder).iv_top3_vip_level.setVisibility(View.GONE);
                }
            }
            ...
            if(rankItems.size()>1) {
                ...
                Glide.with(context).applyDefaultRequestOptions(new RequestOptions().centerCrop()).load(MyUserInstance.getInstance().getAnchorLevel(rankItems.get(1).getAnchor().getAnchor_level())).into(((TopViewHolder) holder).iv_top2_level);
                if(rankItems.get(1).getAnchor().getVip_level()!=null) {
                    if (!rankItems.get(1).getAnchor().getVip_level().equals("0")) {
                        ...
                        Glide.with(context).load(MyUserInstance.getInstance().getVipLevel(rankItems.get(1).getAnchor().getVip_level())).into(((TopViewHolder) holder).iv_top2_vip_level);
                    } else {
                        ((TopViewHolder) holder).iv_top2_vip_level.setVisibility(View.GONE);
                    }
                }
            ...
            if(rankItems.size()>2) {
                ...
                //等级
                Glide.with(context).applyDefaultRequestOptions(new RequestOptions().centerCrop()).load(MyUserInstance.getInstance().getAnchorLevel(rankItems.get(2).getAnchor().getAnchor_level())).into(((TopViewHolder) holder).iv_top3_level);
                //VIP等级
                if(rankItems.get(2).getAnchor().getVip_level()!=null) {
                    if (!rankItems.get(2).getAnchor().getVip_level().equals("0")) {
                        ...
                        Glide.with(context).load(MyUserInstance.getInstance().getVipLevel(rankItems.get(2).getAnchor().getVip_level())).into(((TopViewHolder) holder).iv_top3_vip_level);
                    } else {
                        ((TopViewHolder) holder).iv_top3_vip_level.setVisibility(View.GONE);
                    }
                }
            ...
            Glide.with(context).applyDefaultRequestOptions(new RequestOptions().centerCrop()).load(MyUserInstance.getInstance().getAnchorLevel(rankItems.get(position).getAnchor().getAnchor_level())).into(((ViewHolder) holder).iv_user_level);


            if (rankItems.get(position).getAnchor().getIsattent() == null || rankItems.get(position).getAnchor().getIsattent().equals("0")) {
    ...
    private void follow(RankAnchorItem rankItem, ViewHolder viewHolder) {
        int attent = 0;
        if (rankItem.getAnchor().getIsattent() == null || rankItem.getAnchor().getIsattent().equals("0")) {
            attent = 1;
        ...
        HttpUtils.getInstance().attentAnchor(rankItem.getAnchorid() + "", attent + "", new StringCallback() {
            ...
            public void onSuccess(Response<String> response) {
                ...
                if (data.get("status").toString().equals("0")) {
                    if (rankItem.getAnchor().getIsattent().equals("0")) {
                        viewHolder.tv_attention.setImageDrawable(context.getDrawable(R.mipmap.guanzhu));
                    }
                    if (rankItem.getAnchor().getIsattent().equals("1")) {
