...
public class SuperPlayerVerticalActivity extends BaseMvpActivity<SuperPlayerPresenter> implements SuperPlayerContrat.View
    ...
    public void timeBilling(BaseResponse baseResponse) {
        ...
        if (now_gold < price) {
            LivePriceDialog.Builder builder = new LivePriceDialog.Builder(SuperPlayerVerticalActivity.this);
            builder.create();
            builder.setOnSubmit(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(SuperPlayerVerticalActivity.this, ToPayActivity.class);
    ...
    private void handleRoomMessage(TIMMessage msg, int i) {
        ...
        switch (jsonObject.getString("Action")) {
            ...
            case "LiveFinished":
                if (!SuperPlayerVerticalActivity.this.isFinishing()) {
                    stopPushJoin();
                    builder = new AlertDialog.Builder(SuperPlayerVerticalActivity.this).setTitle("直播结束").setCancelable(false)
            ...
            case "ExplainingGoods":
                ...
                ShopItem shopItem = JSON.toJavaObject(shop_item, ShopItem.class);
                ...
                if (chatFragment != null) {
                    ...
                    Glide.with(SuperPlayerVerticalActivity.this).applyDefaultRequestOptions(options).asBitmap().load(images[0]).into(new SimpleTarget<Bitmap>() {
                        @Override
