...
import com.nasinet.live.dialog.ChatGiftDialogHorizontalFragment;
...
import com.nasinet.live.ui.fragment.AnchorFragment;
import com.nasinet.live.ui.fragment.ChatFragment;
import com.nasinet.live.ui.fragment.ContributionFragment;
...
public class SuperPlayerActivity extends BaseMvpActivity<SuperPlayerPresenter> implements SuperPlayerContrat.View,
                            ...
                            switch (jsonObject.getString("Action")) {
                                ...
                                case "LiveFinished":
                                    if (!SuperPlayerActivity.this.isFinishing()) {
                                        builder = new AlertDialog.Builder(SuperPlayerActivity.this).setTitle("直播结束").setCancelable(false)
    ...
    public class MyPagerChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int arg0) {
            ...
            guardian_tv.setTextSize(TypedValue.COMPLEX_UNIT_SP, 14);
            ...
            switch (arg0) {//状态改变时底部对应的字体颜色改变
                ...
                case 2:
                    ...
                    break;
                case 3:
                    guardian_tv.setTextSize(TypedValue.COMPLEX_UNIT_SP, 20);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.attention_tv:
                if (MyUserInstance.getInstance().visitorIsLogin(SuperPlayerActivity.this)) {
                    HttpUtils.getInstance().checkAttent(hotLive.getAnchorid(), new StringCallback() {
                        @Override
                        public void onSuccess(Response<String> response) {
                            JSONObject jsonObject = JSON.parseObject(response.body());
    ...
    public void timeBilling(BaseResponse baseResponse) {
        ...
        if (now_gold < price) {
            LivePriceDialog.Builder builder = new LivePriceDialog.Builder(SuperPlayerActivity.this);
            builder.create();
            builder.setOnSubmit(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(SuperPlayerActivity.this, ToPayActivity.class);
