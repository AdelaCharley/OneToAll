...
import com.nasinet.live.ui.adapter.AttendUserAdatper;
...
public class AttentUserFragment extends BaseMvpFragment<HomePresenter> implements HomeContract.View {
    ...
    int page = 1;
    List<AttentUser> all_lists = new ArrayList<>();
    ...
    @Override
    public void setAttentUser(ArrayList<AttentUser> bean) {
        if (page == 1) {
