...
import com.nasinet.live.interfaces.OnUserInfoClickListener;
...
public class RankItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (position == 0) {
            ...
            Glide.with(context).applyDefaultRequestOptions(new RequestOptions().centerCrop()).load(MyUserInstance.getInstance().getLevel(rankItems.get(0).getUser().getUser_level())).into(((TopViewHolder) holder).iv_top1_level);
            if(rankItems.get(0).getUser().getVip_level()!=null) {
                if (!rankItems.get(0).getUser().getVip_level().equals("0")) {
                    ...
                    Glide.with(context).load(MyUserInstance.getInstance().getVipLevel(rankItems.get(0).getUser().getVip_level())).into(((TopViewHolder) holder).iv_top1_vip_level);
            ...
            if(rankItems.size()>1){
                ...
                Glide.with(context).applyDefaultRequestOptions(new RequestOptions().centerCrop()).load(MyUserInstance.getInstance().getLevel(rankItems.get(1).getUser().getUser_level())).into(((TopViewHolder) holder).iv_top2_level);

                if(rankItems.get(1).getUser().getVip_level()!=null) {
                    if (!rankItems.get(1).getUser().getVip_level().equals("0")) {
                        ...
                        Glide.with(context).load(MyUserInstance.getInstance().getVipLevel(rankItems.get(1).getUser().getVip_level())).into(((TopViewHolder) holder).iv_top2_vip_level);
            ...
            if(rankItems.size()>2){
                ...
                //等级
                Glide.with(context).applyDefaultRequestOptions(new RequestOptions().centerCrop()).load(MyUserInstance.getInstance().getLevel(rankItems.get(2).getUser().getUser_level())).into(((TopViewHolder) holder).iv_top3_level);
                //VIP等级
                if(rankItems.get(2).getUser().getVip_level()!=null) {
                    if (!rankItems.get(2).getUser().getVip_level().equals("0")) {
                        ...
                        Glide.with(context).load(MyUserInstance.getInstance().getVipLevel(rankItems.get(2).getUser().getVip_level())).into(((TopViewHolder) holder).iv_top3_vip_level);
            ...
            //VIP等级
            if(rankItems.get(position + 1).getUser().getVip_level()!=null) {
                if (!rankItems.get(position + 1).getUser().getVip_level().equals("0")) {

                    if (rankItems.get(position + 1).getUser().getVip_date() == null) {
                        ((ViewHolder) holder).iv_vip_level.setVisibility(View.GONE);
                    } else if (!MyUserInstance.getInstance().OverTime(rankItems.get(position + 1).getUser().getVip_date())) {
                        ((ViewHolder) holder).iv_vip_level.setVisibility(View.GONE);
                    }
                    Glide.with(context).load(MyUserInstance.getInstance().getVipLevel(rankItems.get(position + 1).getUser().getVip_level())).into(((ViewHolder) holder).iv_vip_level);
            ...
            Glide.with(context).applyDefaultRequestOptions(new RequestOptions().centerCrop()).load(MyUserInstance.getInstance().getLevel(rankItems.get(position).getUser().getUser_level())).into(((ViewHolder) holder).iv_user_level);

            if (rankItems.get(position).getUser().getIsattent() == null || rankItems.get(position).getUser().getIsattent().equals("0")) {
