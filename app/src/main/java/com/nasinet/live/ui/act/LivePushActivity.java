...
import com.nasinet.live.dialog.JoinInfoDialog;
...
import com.nasinet.live.ui.adapter.LivePushChatVerticalAdapter;
import com.nasinet.live.ui.adapter.FilterAdapter;
import com.nasinet.live.util.HttpUtils;
import com.nasinet.live.util.MyCredentialProvider;
import com.nasinet.live.util.PhotoUtil;
import com.nasinet.live.dialog.RoomDialog;
import com.nasinet.live.dialog.ShareDialog;
import com.nasinet.live.util.WordUtil;
import com.nasinet.live.widget.ChatPopup;
import com.nasinet.live.widget.CommentAnchorShopList;
...
public class LivePushActivity extends BaseMvpActivity<LivePushPresenter> implements LivePushContrat.View {
    ...
    @OnClick({R.id.garudian_tv, R.id.tv_pk_status, R.id.iv_stop_join, R.id.close_iv, R.id.close_iv_2, R.id.camera_iv, R.id.beauty_iv, R.id.cover_iv, R.id.channel_tv, R.id.start_live_tv, R.id.filter_rl
            ...
            , R.id.rl_normal, R.id.rl_price, R.id.rl_secret, R.id.iv_share,/* R.id.iv_message, R.id.iv_shop, */R.id.ll_room,/* R.id.iv_manager,*/ R.id.iv_more})
        ...
        switch (view.getId()) {
            ...
            case R.id.start_live_tv:
                ...
                if (null == startLive) {
                    ...
                    mPresenter.getTempKeysForCos(MyUserInstance.getInstance().getUserinfo().getId(), MyUserInstance.getInstance().getUserinfo().getToken());
                } else {
            ...
            case R.id.iv_share:
                ...
                Glide.with(LivePushActivity.this).load(startLive.getThumb()).into(new SimpleTarget<Drawable>() {
                    @Override
                    public void onResourceReady(@NonNull Drawable resource, @Nullable Transition<? super Drawable> transition) {
                        ShareDialog.Builder builder = new ShareDialog.Builder(LivePushActivity.this);
            ...
            case R.id.iv_more:
                ...
                if (bottomList == null) {
                    ...
                    bottom_builder = new XPopup.Builder(LivePushActivity.this);
                                ...
                                HttpUtils.getInstance().getGoodsList(MyUserInstance.getInstance().getUserinfo().getId(), new StringCallback() {
                                    ...
                                    public void onSuccess(Response<String> response) {
                                        ...
                                        if (HttpUtils.getInstance().swtichStatus(data)) {
                                            ...
                                            if (null != datas) {
                                                shopItems = JSON.parseArray(datas.toJSONString(), ShopItem.class);
                                                if (shopItems == null) {
                                                ...
                                                CommentAnchorShopList commentShopList = new CommentAnchorShopList(LivePushActivity.this, shopItems);
    ...
    public void endlive(BaseResponse endlive) {
        ...
        builder = new AlertDialog.Builder(LivePushActivity.this).setTitle(WordUtil.getString(R.string.Live_Finish)).setCancelable(false)
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == TAKE_PHOTO && resultCode == RESULT_OK) {
            ...
            Glide.with(LivePushActivity.this).applyDefaultRequestOptions(new RequestOptions().centerCrop().diskCacheStrategy(DiskCacheStrategy.ALL)).load(imageFile).into(cover_iv);
    ...
    private void finishEndDialog() {
        if (null == cosXmlService) {
            ...
            if (null != startLive) {
                builder = new AlertDialog.Builder(LivePushActivity.this).setTitle("结束直播").setCancelable(false)
    ...
    public void initGuardianlist() {
        ...
        new XPopup.Builder(context)
                ...
                .moveUpToKeyboard(false) //如果不加这个，评论弹窗会移动到软键盘上面
                .asCustom(commentGuardianList/*.enableDrag(false)*/)
                .show();
