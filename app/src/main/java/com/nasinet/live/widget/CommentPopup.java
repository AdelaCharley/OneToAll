...
import com.nasinet.live.dialog.RePlayCommentDIalog;
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        if (data.get("status").toString().equals("0")) {
                            if (null != data.getJSONArray("data")) {
                                ...
                                Glide.with(getContext()).load(MyUserInstance.getInstance().getLevel(comment.getUser().getUser_level())).into(iv_user_level);
