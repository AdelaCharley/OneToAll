...
public abstract class OthrBase2Activity extends NasiOtherBaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getAdminListner();
        rootView = View.inflate(this, com.nasinet.nasinet.R.layout.other_base_2_activity, null);
        addContent();
    ...
    public void addContent() {
        tv_title = rootView.findViewById(com.nasinet.nasinet.R.id.tv_title);
        rl_back = rootView.findViewById(com.nasinet.nasinet.R.id.rl_back);
        ...
        rl_title = rootView.findViewById(com.nasinet.nasinet.R.id.rl_title);
        tv_other = rootView.findViewById(com.nasinet.nasinet.R.id.tv_other);
        FrameLayout flContent = (FrameLayout) rootView.findViewById(com.nasinet.nasinet.R.id.fl_content);
    ...
    public void upLoadImage2(QCloudData data, String imagePath) {
        ...
        cosXmlService.putObjectAsync(putObjectRequest, new CosXmlResultListener() {
            ...
            public void onSuccess(CosXmlRequest cosXmlRequest, CosXmlResult result) {
                ...
                if (onUploadFinshListener2 != null) {
                    onUploadFinshListener2.onFinish(putObjectResult.accessUrl);
                }
            }
            ...
            public void onFail(CosXmlRequest cosXmlRequest, CosXmlClientException clientException, CosXmlServiceException serviceException) {
                hideLoading();
                if (onUploadFinshListener2 != null) {
                    onUploadFinshListener2.onFinish("");
                }
                // todo Put object failed because of CosXmlClientException or CosXmlServiceException...
            }
        });
