...
import com.nasinet.live.interfaces.OnItemClickListener;
...
import com.nasinet.live.ui.adapter.ChatGiftCountAdapter;
import com.nasinet.live.ui.adapter.ChatGiftPagerAdapter;
import com.nasinet.live.ui.adapter.ChatGiftPagerAdapter2;
...
public class ChatGiftDialogHorizontalFragment extends AbsDialogFragment implements View.OnClickListener, OnItemClickListener<String>, ChatGiftPagerAdapter2.ActionListener {
    ...
    private ChatGiftPagerAdapter2 mLiveGiftPagerAdapter;
    ...
    protected int getLayoutId() {
        return R.layout.dialog_chat_gift_horizontal;
    }
    ...
    private void showGiftList(List<ChatGiftBean> list) {
        mLiveGiftPagerAdapter = new ChatGiftPagerAdapter2(mContext, list);
