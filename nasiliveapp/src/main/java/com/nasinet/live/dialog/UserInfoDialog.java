    ...
    public static class Builder {
        ...
        public UserInfoDialog create() {
            ...
            if (null != userRegist) {
                ...
                //等级
                if (type.equals("1")) {
                    Glide.with(context).load(MyUserInstance.getInstance().getLevel(userRegist.getUser_level())).into(iv_level);
                } else {
                    Glide.with(context).load(MyUserInstance.getInstance().getAnchorLevel(userRegist.getAnchor_level())).into(iv_level);
                }
                //年级
                ...
                if (userRegist.getVip_level() != null&userRegist.getVip_date()!=null) {
...
//购买会员
            ...
            tv_sixin.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(MyUserInstance.getInstance().visitorIsLogin((Activity) context)) {
                        MyUserInstance.getInstance().startChatActivity(context, userRegist.getId(), userRegist.getNick_name(), ChatActivity.class);
                    }
                }
            });
            //主页
