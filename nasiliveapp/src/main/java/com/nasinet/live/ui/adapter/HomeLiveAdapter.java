...
public class HomeLiveAdapter extends BaseQuickAdapter<HotLive, BaseViewHolder> {
    private com.nasinet.live.ui.os.OnItemClickListener onItemClickListener;
    Context context;
    ...
    public void setOnItemClickListener(com.nasinet.live.ui.os.OnItemClickListener onItemClickListener) {
    ...
    protected void convert(@NonNull BaseViewHolder helper, HotLive item) {
        ...
        if (item.getAnchor().getAnchor_level() != null) {
            helper.setImageResource(R.id.iv_anchor_level, MyUserInstance.getInstance().getAnchorLevel(item.getAnchor().getAnchor_level()));
        } else {
