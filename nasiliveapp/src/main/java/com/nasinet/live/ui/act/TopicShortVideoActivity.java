...
public class TopicShortVideoActivity extends BaseMvpActivity<HomePresenter> implements HomeContract.View {
    ...
    private ShortVideoListFragment list_hot;
    private ShortVideoListFragment list_new;
    ...
    private void setupViewPager() {
        ...
        if (adapter == null) {
            ...
            list_hot = new ShortVideoListFragment();
            ...
            list_new = new ShortVideoListFragment();
