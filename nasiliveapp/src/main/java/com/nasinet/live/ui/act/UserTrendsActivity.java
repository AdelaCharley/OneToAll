...
import com.nasinet.live.dialog.UserTrendCommentDialog;
...
import com.nasinet.live.ui.adapter.UserTrendAdapter;
...
public class UserTrendsActivity extends BaseMvpActivity<HomePresenter> implements View.OnClickListener, HomeContract.View, BGANinePhotoLayout.Delegate, UserTrendAdapter.OnItemClickListener {
    ...
    protected void initData() {
        ...
        if (my_trend.getUser().getProfile().getGender().equals("1")) {
        ...
        Glide.with(this).load(MyUserInstance.getInstance().getLevel(my_trend.getUser().getUser_level())).into(iv_user_level);
